...
export default function ServerError() {
    return (
        <div className={styles.container}>
            <Head>
                <title>500 | Takeout</title>
                <meta name="viewport" content="width=device-width, initial-scale=0.7" />
                <meta name="description" content="500 | A simple, affordable, developer-oriented email service." />
                ...
                <meta property="og:title" content="500 | Takeout" />
                <meta property="og:description" content="500 | A simple, affordable, developer-oriented email service." />
                <meta property="og:type" content="website" />
                <meta property="og:image" content="https://i.ibb.co/28RgWJs/takeout.png" />
                <meta property="og:locale" content="en_US" />
                <meta name="twitter:card" content="summary" />
                <meta name="twitter:title" content="500 | Takeout" />
                <meta name="twitter:description" content="500 | A simple, affordable, developer-oriented email service." />
            ...
            <div className={styles.sections}>
                <section className={styles.loginSecLeft}>
                    <img src="https://i.ibb.co/wRPz26d/undraw-server-down-s-4-lk.png" width='300px' />
                </section>
                ...
                <section className={styles.loginSecRight}>
                    <div className={styles.loginRightText}>
                        <h1 className={styles.homeHook} style={{ marginBottom: '30px' }}>
                            Some extremely strange <b>500 error appeared.</b>
                        </h1>
